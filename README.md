...
| `D_Age`        | int    | 6-digit birth date, YYMMDD         |
...
| `Q01` … `Q50`  | int    | Multiple-choice answer codes. Yes/No questions use 1 = Yes, 2 = No. Categorical questions use 1/2/3 in the order presented in the app. |
| `App_isOld`      | int    | App-side age flag       |
| `App_isVas`      | int    | App-side vascular flag   |
| `App_vasScore`   | int    | App-side vascular count  |
...
`OH`, and the out-of-scope placeholder `OTHERS`.
